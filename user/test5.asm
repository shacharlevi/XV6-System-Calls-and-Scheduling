...
if(fork()==0){
  ...
  10:	e519                	bnez	a0,1e <main+0x1e>
    set_ps_priority(10);
  12:	4529                	li	a0,10
  14:	00000097          	auipc	ra,0x0
  18:	34e080e7          	jalr	846(ra) # 362 <set_ps_priority>
    for(;;){
  1c:	a001                	j	1c <main+0x1c>
  ...
  24:	342080e7          	jalr	834(ra) # 362 <set_ps_priority>
    for(;;){
...
_main()
{
  ...
  3e:	7d658593          	addi	a1,a1,2006 # 810 <malloc+0xf0>
  42:	4501                	li	a0,0
...
0000000000000362 <set_ps_priority>:
...
000000000000036a <set_cfs_priority>:
...
0000000000000372 <get_cfs_stats>:
...
0000000000000382 <get_ps_priority>:
