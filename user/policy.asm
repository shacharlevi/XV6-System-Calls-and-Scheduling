...
int main(int argc, char *argv[]) {
  ...
  38:	82450513          	addi	a0,a0,-2012 # 858 <malloc+0xfc>
  ...
  56:	7ee50513          	addi	a0,a0,2030 # 840 <malloc+0xe4>
  5a:	00000097          	auipc	ra,0x0
  5e:	644080e7          	jalr	1604(ra) # 69e <printf>
        return -1;
  62:	597d                	li	s2,-1
...
_main()
{
  ...
  7a:	80258593          	addi	a1,a1,-2046 # 878 <malloc+0x11c>
  7e:	4501                	li	a0,0
...
00000000000003be <get_ps_priority>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 40e:	47e50513          	addi	a0,a0,1150 # 888 <digits>
 412:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4da:	3b2b8b93          	addi	s7,s7,946 # 888 <digits>
 ...
 61a:	26a90913          	addi	s2,s2,618 # 880 <malloc+0x124>
        while(*s != 0){
