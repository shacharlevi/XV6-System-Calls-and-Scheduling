...
main(void)
{
  ...
  14:	8e050513          	addi	a0,a0,-1824 # 8f0 <malloc+0xee>
  ...
  3c:	8c098993          	addi	s3,s3,-1856 # 8f8 <malloc+0xf6>
    }
  ...
  44:	8e890913          	addi	s2,s2,-1816 # 928 <malloc+0x126>
    printf("init: starting sh\n");
  48:	854e                	mv	a0,s3
  ...
  7a:	8da50513          	addi	a0,a0,-1830 # 950 <malloc+0x14e>
  7e:	00000097          	auipc	ra,0x0
  82:	6c6080e7          	jalr	1734(ra) # 744 <printf>
        exit(1,"");
  86:	00001597          	auipc	a1,0x1
  8a:	8a258593          	addi	a1,a1,-1886 # 928 <malloc+0x126>
  8e:	4505                	li	a0,1
  ...
  a0:	85450513          	addi	a0,a0,-1964 # 8f0 <malloc+0xee>
  a4:	00000097          	auipc	ra,0x0
  a8:	350080e7          	jalr	848(ra) # 3f4 <mknod>
    open("console", O_RDWR);
  ac:	4589                	li	a1,2
  ae:	00001517          	auipc	a0,0x1
  b2:	84250513          	addi	a0,a0,-1982 # 8f0 <malloc+0xee>
  b6:	00000097          	auipc	ra,0x0
  ba:	336080e7          	jalr	822(ra) # 3ec <open>
  be:	b79d                	j	24 <main+0x24>
      printf("init: fork failed\n");
  c0:	00001517          	auipc	a0,0x1
  c4:	85050513          	addi	a0,a0,-1968 # 910 <malloc+0x10e>
  c8:	00000097          	auipc	ra,0x0
  cc:	67c080e7          	jalr	1660(ra) # 744 <printf>
      exit(1,"");
  d0:	00001597          	auipc	a1,0x1
  d4:	85858593          	addi	a1,a1,-1960 # 928 <malloc+0x126>
  d8:	4505                	li	a0,1
  ...
  ee:	84650513          	addi	a0,a0,-1978 # 930 <malloc+0x12e>
  f2:	00000097          	auipc	ra,0x0
  f6:	2f2080e7          	jalr	754(ra) # 3e4 <exec>
      printf("init: exec sh failed\n");
  fa:	00001517          	auipc	a0,0x1
  fe:	83e50513          	addi	a0,a0,-1986 # 938 <malloc+0x136>
 102:	00000097          	auipc	ra,0x0
 106:	642080e7          	jalr	1602(ra) # 744 <printf>
      exit(1,"");
 10a:	00001597          	auipc	a1,0x1
 10e:	81e58593          	addi	a1,a1,-2018 # 928 <malloc+0x126>
 112:	4505                	li	a0,1
...
_main()
{
 ...
 130:	7fc58593          	addi	a1,a1,2044 # 928 <malloc+0x126>
 134:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4b4:	4c850513          	addi	a0,a0,1224 # 978 <digits>
 4b8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 580:	3fcb8b93          	addi	s7,s7,1020 # 978 <digits>
 ...
 6c0:	2b490913          	addi	s2,s2,692 # 970 <malloc+0x16e>
        while(*s != 0){
