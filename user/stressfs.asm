...
main(int argc, char *argv[])
{
  ...
  1a:	91278793          	addi	a5,a5,-1774 # 928 <malloc+0x11e>
  1e:	6398                	ld	a4,0(a5)
...
//    printf(fd, "%d\n", i);
  ...
  fc:	82858593          	addi	a1,a1,-2008 # 920 <malloc+0x116>
 100:	4501                	li	a0,0
 ...
 10e:	81658593          	addi	a1,a1,-2026 # 920 <malloc+0x116>
 112:	4501                	li	a0,0
...
_main()
{
 ...
 130:	7f458593          	addi	a1,a1,2036 # 920 <malloc+0x116>
 134:	4501                	li	a0,0
